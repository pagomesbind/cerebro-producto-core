---
id: 2026-09-01_onboarding_normativa_identificacion_pj_vinculados
pm: pablo
fecha_captura: 2026-09-01
fuente: "Research de Pablo Gomes con Gemini (deep research, con citas a fuentes públicas: UIF/Boletín Oficial) — 'Mapeo Exhaustivo de Requisitos Regulatorios y Datos Obligatorios para CVU en Argentina.md', 2026-09-01, archivado en 4_archivos/historial_raw/2026-09_normativa_cvu_pf_argentina/"
producto: onboarding
tema: Requisitos UIF de identificación para personas jurídicas, vehículos colectivos (FCI/Fideicomiso) y sujetos vinculados/beneficiario final
tipo: conocimiento
...
Misma reserva que el item hermano de personas físicas ([`2026-09-01_onboarding_normativa_identificacion_pf_cvu`](2026-09-01_onboarding_normativa_identificacion_pf_cvu.md)): investigación de IA (Gemini deep research) con citas públicas, no validada línea por línea por Compliance/Legales todavía. Tratar como orientación de diseño, no como ground truth de auditoría, hasta esa validación.

## Resumen — la UIF exige desagregar "quién es el cliente" de "quién controla/representa al cliente"

Para personas jurídicas, Fondos Comunes de Inversión (FCI) y Fideicomisos, la Resolución UIF 78/2023 (Reportes Sistemáticos Mensuales de Cuentas Comitentes y FCI) exige no solo los datos propios de la entidad, sino la identificación de un conjunto de personas humanas vinculadas — "el ordenamiento regulatorio argentino proscribe el anonimato indirecto" mediante estas obligaciones. Igual que en el caso de personas físicas, hay una distinción entre lo exigible en el **Legajo de Cliente (DDC)** y lo exigible en el **layout técnico del RSM** — el legajo es siempre la exigencia de máxima; el RSM puede marcar campos como opcionales por eficiencia de ingesta masiva sin que eso relaje la obligación de tenerlos en el legajo.
...
No es contenido nuevo para el proyecto de PJ ya en curso, sino confirmación con base normativa citada: [`proyecto-la-virginia-ob-pj`](../proyecto-la-virginia-ob-pj/proyecto.md) ya registró (2026-08-20) que "beneficiarios finales confirmado cubierto por una US existente" y ya construye alta de representantes legales/apoderados con su propia validación de identidad (US-2/US-3/US-7). Esta matriz sirve como checklist de referencia si se quiere verificar formalmente ese diseño campo a campo (no hecho en esta sesión — el contrato de datos detallado de ese proyecto no se comparó línea por línea como sí se hizo con PRD-202/PF). Relevante también para **PRD-210** (Fase 3 — cuenta PJ del proyecto Onboarding Estratégico, hoy en horizonte "Más tarde", sin discovery de campos todavía) cuando se retome.

## Reglas transversales (compartidas con el item de personas físicas)

Ver [`2026-09-01_onboarding_normativa_identificacion_pf_cvu`](2026-09-01_onboarding_normativa_identificacion_pf_cvu.md) para la excepción de tipping-off, las alertas de coherencia edad/capacidad (Art. 23) y la prohibición de anonimato — aplican de igual forma a la identificación de vinculados/beneficiarios finales de personas jurídicas.
