---
id: 2026-08-19_onboarding_integracion_worldsys_complianceone
pm: pablo
fecha_captura: 2026-08-19
fuente: "/idea_solution sobre PRD-147 — extracción del Swagger público de ComplianceOne (v1.0.0, 518 endpoints, capturado 2026-07-20) y del hilo de mail con Worldsys (Pablo Stach, Gonzalo Quintana, Matias Quimey Larumbe, 2026-04-15 a 2026-08-14)"
producto: onboarding
tema: Contrato técnico de la API ComplianceOne de Worldsys (repositorio de legajo documental)
tipo: conocimiento
destino_propuesto: wiki/3_recursos/detalle_productos/onboarding/integracion_worldsys_complianceone.md
tipo_destino: crear
contradice: "no"
confianza: alta
estado: en_cola
