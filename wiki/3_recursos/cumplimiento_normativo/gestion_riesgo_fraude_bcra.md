# Gestión de riesgo de fraude — Comunicaciones "A" 8471 y 8473 (BCRA)

> Estado: discovery cerrado (Gate 1/2), Gate 3 pendiente — ver `1_proyectos/gestion_riesgo_fraude/` (Pablo Gomes). Cronograma de implementación en curso desde 2026-09-01.
...
Bind PSP es **PSPCP** (tiene licencia de PSP del BCRA y ofrece cuentas de pago — CVU — vía Wallet) y también **PSPCP como Servicio** — ambas categorías comparten el mismo cronograma y el mismo régimen pleno de la Sección 6, equivalente al de las entidades financieras. Un socio de la Cámara preguntó si, siendo PSPCP y PSP a la vez, aplica el calendario más corto del régimen acotado — la respuesta confirmada es que **no**: el régimen de PSPCP es el techo regulatorio, cumplirlo satisface cualquier obligación menor de otros roles (aceptador/agregador), sin necesidad de duplicar estructura — basta con que la matriz de riesgo de PSPCP incorpore los riesgos de esas otras actividades.
...
Mail de la Cámara Argentina Fintech (Mariano Giraffa, 2026-09-03) + PDF Comunicación "A" 8473 (BCRA, 03/09/2026) + reunión CAF "Encuentro informativo Socios - Com. A 8471" (2026-09-04) + documento de análisis legal de la Cámara sobre la 8471 (agosto 2026). Detalle completo con citas en `1_proyectos/gestion_riesgo_fraude/proyecto.md` (§2 y anexo de discovery) y su carpeta `referencias/`.

> Capturado por Pablo Gomes, 2026-09-07.
