...
---
*Última actualización: 2026-09-25 — `/context_merge`: `limites_operativos_uif_ros.md` nueva sección — regla de revisión PLD obligatoria para legajos PJ >$10.000/mes desde el 1/10/2026 (posible reapertura de la disputa $1.000/$10.000 ya dada por resuelta, ver gap en `2_areas/gaps_y_preguntas.md`).*
*Última actualización anterior: 2026-09-11 — `/context_merge`: 2 archivos nuevos — [coelsa_cpf_central_prevencion_fraude.md](coelsa_cpf_central_prevencion_fraude.md) y [coelsa_prevent_scoring_y_on_hold.md](coelsa_prevent_scoring_y_on_hold.md) (Central de Prevención de Fraude y scoring/ON HOLD de Coelsa, desde ingesta manual de documentación pública de Pablo Gomes); `identificacion_personas_juridicas_vinculados.md` nueva sección Wallet Data Service (documentación exigida por BCRA), desde contexto_vivo de Nicolás Colón.*
