...
> **Corrección (2026-09-24):** el discovery de `titularidad_tarjeta` **no llegó a esta solución de forma independiente** — el reenvío de Pablo Gomes a Nicolás Colón del 2026-09-10 (ver arriba) fue justamente lo que disparó el `/idea_start` del proyecto (2026-09-10 al 2026-09-15) sobre la IDEA de Jira PRD-25 que ya existía. El equipo retomó a propósito la propuesta de MODO a partir de ese reenvío. Queda sin confirmar únicamente **por qué** Pablo Gomes reenvió el mail justo en ese momento, 18 meses después del original — la tarea de seguimiento (T-046) se cerró el 2026-09-15 sin necesidad de esa respuesta para el proyecto. El pendiente sobre si el contrato de 2025 (`PDSA - Acuerdo VATA`) sigue vigente se mantiene sin resolver (ver más abajo).

Casi un año y medio después de ese mail, el proyecto **`titularidad_tarjeta`** (Nicolás Colón, foco Ardid/Adquirencia, PRD-25) diseñó una integración con "VaTa (MODO)" para resolver exactamente el mismo problema (Bind no valida hoy la titularidad de la tarjeta en Botón Simple, generando contracargos por "tarjeta no propia"). Ver el diseño completo ya cerrado en [`2_areas/direccion/iniciativas.md`](../../../2_areas/direccion/iniciativas.md) (fila `titularidad_tarjeta`):
...
---
*Última actualización: 2026-09-25 — `/context_merge`: corrección en "Por qué es relevante ahora" — el reenvío del 2026-09-10 fue el disparador confirmado del discovery de PRD-25, no una llegada independiente a la misma solución (dato del install de Nicolás Colón del 2026-09-15, no subido al core antes del merge del 2026-09-23).*
*Última actualización anterior: 2026-09-23 — `/context_merge`: archivo nuevo, a pedido explícito del usuario de encasillar la API VATA de MODO como servicio externo de Adquirencia (mismo criterio que Coelsa/API Bank), conectándola con el proyecto activo `titularidad_tarjeta` que ya la integra en su diseño.*
