...
**Evidencia adicional sobre Global66 (2026-09-02, no cierra la contradicción):** dos reuniones nuevas confirman que **Global66** es, como mínimo, un cliente real con reclamo activo y documentado de latencia QR — no una atribución dudosa. "Bind Global66, proximos pasos" (mesa técnica dedicada): equipo interno de Bind mide ~7s de procesamiento, Global66 reporta 15-20s percibidos (promedio 10-12s, P95 16s); un caso puntual validado con logs de ambos lados (Agustín Grau, Fintexa) dio 6,8s reales del lado de Bind, consistente con la medición interna — hipótesis abierta de que la medición de Global66 arranca desde el MFA del usuario, no desde que la petición llega a Bind. "Join Soporte Clientes" (misma jornada): Mauro Suppan reportó el mismo reclamo de Global66 como tema de agenda de soporte. Ninguna de las dos reuniones menciona la reunión del 2026-08-31 ni confirma que el ajuste T1/T2 haya sido respuesta directa a Global66 — la contradicción TPay vs. BSF/Global66 (ver gap) sigue abierta. Detalle técnico adicional confirmado (refuerza lo ya documentado arriba): la primera consulta a Coelsa ocurre a los 4,5s y, si no resuelve, la segunda a los 6,5-7s — cubre el 99% de los casos; el remanente pasa al state monitor, que reconsulta cada 30 segundos.
