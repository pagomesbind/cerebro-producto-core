# GET — Consultar Solicitud por ID Externo (Validación por Partes)

> Fuente: https://psp.bind.com.ar/developers/apis/consultar-solicitud-por-id-externo-copy
...
|-----------|------|-----------|-------------|
| `externalrefid` | string (path) | REQUIRED | Identificador externo indicado por la propia Entidad. |
