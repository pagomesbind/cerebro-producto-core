...
| 1.19 | ~18/09/2026 | **Akurtech** | Release ya disponible (manual de actualización, informe de cambios y paquete completo notificados por Pentass — no descargados por este flujo). **No incluye** el fix de zona horaria (UTC 0). **Se decidió omitir su despliegue** (ver decisión del 22/09 abajo) — se salta directo a la 1.19.1. |
| 1.19.1 | Sin fecha confirmada (ya desarrollada, en testing) — **confirmada disponible del lado del proveedor el 22/09/2026** | **Akurtech** | Incluye **todo lo de UTC 0** — fix de zona horaria mapeado como consecuencia de las ráfagas de tráfico detectadas en COTO. Pablo Gomes confirmó con Lorena Macedo (Pentass) que este fix NO está en la 1.19. **Decisión (22/09/2026, "Repaso Semanal líderes"): se salta directo a esta versión, omitiendo la 1.19**, primero en staging y luego en producción. |
...
> **Decisión de salto directo a 1.19.1 (22/09/2026, reunión "Repaso Semanal líderes"):** el equipo acordó omitir el despliegue de la 1.19 y saltar directo a la 1.19.1 en los ambientes — no tiene sentido pasar primero por una versión sin el fix UTC 0 cuando la 1.19.1 ya está disponible para subir. Daniel Zalazar (Fintexa) confirmó en la misma reunión que la 1.19.1 ya se encuentra subida del lado del proveedor. Seguimiento operativo: Mateo Capitanich (Fintexa) crea el ticket para actualizar staging a la 19.1 (saltando la 19.0); Andrea Orsini (Bind PSP) coordina la ventana de pase a producción. Esta decisión resuelve de facto la tarea T-114 (pedir a Lorena Macedo el roadmap con fecha estimada de la 1.19.1) — ya no hace falta esperar una fecha de release formal.
