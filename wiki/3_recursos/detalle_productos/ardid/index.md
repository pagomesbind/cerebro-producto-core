...
| [despliegues_y_operacion.md](despliegues_y_operacion.md) | Protocolo estándar de rollback de un despliegue (imagen Docker + restore de base de datos cuando el despliegue tocó datos) y riesgo de rechazos al activar reglas antifraude no aplicadas — caso Coto (AD-1374) | Reunión "Análisis de Riesgo - Fix de cambios de estados de las tarjetas" (2026-08-28) |
...
---
*Última actualización: 2026-08-31 — `/context_merge`: archivo nuevo `despliegues_y_operacion.md` (protocolo de rollback de dos pasos, riesgo de reglas antifraude no aplicadas — caso Coto/AD-1374).*
