...
---
*Última actualización: 2026-08-15/18 — `/sync_releases` + `/sync_meetings`: nueva §10 "Infraestructura y confiabilidad — tramo W71" (Redis, migración EasyNet, anti-affinity, WebhookSender a PROD) y §10.1 (reducción de microservicios/nodos del clúster).*
