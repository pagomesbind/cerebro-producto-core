# GET — Consultar Operación por ID (Dólar CCL)

> Fuente: https://psp.bind.com.ar/developers/apis/consultaroperacionporid-dolarccl
...
| `comprobanteDevolucionId` | int | Identificador del comprobante de devolución (si aplica). |
