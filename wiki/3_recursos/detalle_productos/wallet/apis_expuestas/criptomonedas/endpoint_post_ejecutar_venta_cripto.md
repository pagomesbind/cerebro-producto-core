# POST — Ejecutar Venta de Cripto

> Fuente: https://psp.bind.com.ar/developers/apis/ejecutar-venta-cripto
> Producto: Wallet — Cripto

## Descripción

Ejecuta una intención de venta de una criptomoneda previamente creada.
...
|-------|-------|
| Método | `POST` |
| URL (Staging) | `https://gw-staging-qrbind.epays.services/walletentidad-investment/v1/api/v1.201/EjecutarVentaCripto` |
...
```bash
curl --location 'https://gw-staging-qrbind.epays.services/walletentidad-investment/v1/api/v1.201/EjecutarVentaCripto' \
...
| `montoCambio` | double | Monto a obtener, neto de gastos. |
...
| `comprobanteId` | int | Comprobante del crédito de moneda FIAT. |
