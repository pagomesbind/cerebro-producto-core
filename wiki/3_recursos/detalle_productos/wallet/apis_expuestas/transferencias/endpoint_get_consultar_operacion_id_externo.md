...
> Fuente: https://psp.bind.com.ar/developers/apis/consultaroperacionporidext-transferencias
...
|-----------|------|-----------|-------------|
| `idExterno` | string | REQUIRED | Identificador o código externo de la entidad informado al momento de la creación de la operación (path param). |
