...
**Decisión (2026-09-07) — todo ticket cargado por Fintexa debe pasar obligatoriamente por Nicolás Colón antes de avanzar.** En la reunión "Weekly - Producto / Operaciones", Pablo Gomes cuestionó la falta de rigor de Fintexa en la documentación/carga de tickets (caso puntual: comentario incompleto de un analista sobre el error de PMC, archivo vacío), y se detectó que Nicolás Colón recibía notificaciones de tickets de forma dispersa (mail + Teams, a veces de madrugada), sin que el análisis quedara centralizado en el propio ticket. Pablo Gomes y Gonzalo Rivera acordaron exigir un **proceso estricto de emisión de tickets que pasen obligatoriamente por Nicolás Colón** antes de avanzar, para control interno y para poder medir de forma real los tiempos de respuesta de Fintexa — cambia el flujo operativo de cómo el equipo interactúa con Fintexa, cualquier ticket de desarrollo nuevo debería enrutarse por él, no ingresar directo. Sugerencia adicional sin resolución formal (Nicolás Colón): pegar el análisis técnico directamente en el ticket para consolidar la información en un solo lugar, en vez de centralizar solo la recepción. Sin fecha de implementación formal ni ajuste operativo adicional documentado más allá de este acuerdo.
...
---
*Última actualización: 2026-09-23 — `/context_merge`: §1.7 suma la decisión del 2026-09-07 (todo ticket de Fintexa debe pasar obligatoriamente por Nicolás Colón antes de avanzar).*
*Última actualización anterior: 2026-08-14 — `/sync_meetings`: nueva sección "Acceso a Jira ampliado a todo el equipo" (decisión de transparencia + diagnóstico de capacidad de desarrollo y mesa quincenal con Fintexa). Ver reunión "Priorizacion y backlog" (2026-08-13) en `wiki/2_areas/control/log_reuniones.md`.*
