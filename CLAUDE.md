...
`gaps y decisiones del proyecto (directo, si aplica) → tareas personales (1_proyectos/tareas.md) → todo aporte al canon como item de contexto_vivo/ (conocimiento/tarea_equipo/decision/oportunidad/riesgo/gap/dato/iniciativa) → índices de 1_proyectos/ que hayas tocado → verificación de que ninguna carpeta tocada quedó sin index.md → logs_sync/log_context.md si corriste una skill de sync → rotación de raw/`
