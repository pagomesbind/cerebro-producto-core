...
|---|---|---|---|
| [2026-08-19](2026-08-19.md) | 37 (todos de pablo) | 0 | Bug de `/context_push` detectado (items llegaron `capturado` en vez de `en_cola`) — sorteado con permiso del usuario, ver nota de proceso en el manifiesto. 2 permisos de régimen D otorgados. |
